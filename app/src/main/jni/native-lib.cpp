...
#include "com_example_iris_recorder_WebrtcProcessor.h"
...
Java_com_example_iris_recorder_WebrtcProcessor_init(JNIEnv *env, jobject instance, jint sample_rate) {
...
JNIEXPORT jboolean JNICALL
Java_com_example_iris_recorder_WebrtcProcessor_processNoise(JNIEnv *env, jobject instance, jshortArray sample) {
...
Java_com_example_iris_recorder_WebrtcProcessor_release(JNIEnv *env, jobject instance) {
